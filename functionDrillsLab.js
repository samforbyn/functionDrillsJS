...
function nameCheck(name){
  ...
  if(newName.includes("steven")){
    console.log("What is up Steven?")
  }else if(newName.includes("bryan")){
...
////////////////// PROBLEM 10 ////////////////////
let contestants = ['Katniss', 'Peeta', 'Fox-face','Cato', 'Rue', 'Thresh', 'Clove', 'Marvel']
let loser = 'Glimmer'
/*
...
let newThing = theEliminator(contestants, loser)
...
// console.log(emailCheck("samforbyn@gmail.com"))
...
//CODE HERE
function chocFrog2(g){
  let frogs = 3
  maxAmt = g / frogs
  return Math.floor(maxAmt)
...
let arrayIsAscending = arrOfNum(sampleArray)
